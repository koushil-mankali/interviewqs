/**
 * QS: Write a react app which fetches data from api and displays on screen, and when user scrolls down to 90% of the page, it fetches more data and appends it to the existing data.
 */
